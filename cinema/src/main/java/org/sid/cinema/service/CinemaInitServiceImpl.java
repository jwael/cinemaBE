...
public class CinemaInitServiceImpl implements ICinemaInitService {
	...
	public void initVilles() {
		Stream.of("Casa","Tunis","Tolouse","Paris").forEach( nameVille->{
	...
	public void initCinemas() {
		villeRepository.findAll().forEach(v->{
			Stream.of("MEGACinema","Royal","LabegeCinema","MGC","CV")
			.forEach( nameCinema ->{
	...
	public void initSeances() {
		DateFormat dfDateFormat = new SimpleDateFormat("HH:mm");
		Stream.of("12:00","15:00","17:00","19:00","21:00").forEach(s->{
			Seance seance= new Seance();
			try {
				seance.setHeureDebut(dfDateFormat.parse(s));
	...
	public void initCategories() {
		...
		Stream.of("Action","Drama","Histoire","Fiction").forEach(cat->{
	...
	public void initFilms() {
		...
		Stream.of("Game of thrones","le Parrain","Jesus","spiderman","ironman").forEach(titreFilm->{
			Film film = new Film();
	...
	public void initProjections() {
		double[] prices = new double[] {10,15,20,5};
